# from https://github.com/TengdaHan/DPC/blob/master/backbone/resnet_2d3d.py
...
class ResNet2d3d_full(nn.Module):
    ...
    def __init__(self, block, layers, track_running_stats=True):
        ...
        self.layer4 = self._make_layer(block[3],
                                       256,
                                       layers[3],
                                       stride=2,
                                       is_final=True)
...
def resnet18_2d3d_full(**kwargs):
    ...
    model = ResNet2d3d_full(
        [BasicBlock2d, BasicBlock2d, BasicBlock3d, BasicBlock3d], [2, 2, 2, 2],
        **kwargs)
    return model
...
def resnet34_2d3d_full(**kwargs):
    ...
    model = ResNet2d3d_full(
        [BasicBlock2d, BasicBlock2d, BasicBlock3d, BasicBlock3d], [3, 4, 6, 3],
        **kwargs)
    return model
...
def resnet50_2d3d_full(**kwargs):
    ...
    model = ResNet2d3d_full(
        [Bottleneck2d, Bottleneck2d, Bottleneck3d, Bottleneck3d], [3, 4, 6, 3],
        **kwargs)
    return model
